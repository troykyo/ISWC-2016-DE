...
performance of the sensor in their specific contexts. In the use of a shoes we
can understand not only how hard the foot is being pressed, but if the foot is
...
context of a automative steering wheel we can understand not only where someone
is touching, but how they move there hands when engaged in an maneuver such as
turning a corner.
 The use of multiple sensors for greater movement vector and specific specific
